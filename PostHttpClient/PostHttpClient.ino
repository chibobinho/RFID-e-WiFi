...
char ssid[] = "Vermelho"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "Vermelho@132";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  WiFi.config(IPAddress(192,168,100,61)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
...
void sendHttpResponse(WiFiEspClient client){
  Serial.println("Não tente acessar o site!!!!");
